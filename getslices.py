...
def save_image_2d_data_as_png_file(img_data, filename, output):
    ...
    #return img_data_uint8

   #axes[1].imshow(img_data_uint8, cmap='grey', origin='lower')
    #plt.suptitle('Nao sei')
    #plt.show()
    #png_img = Image.fromarray(img_data)
...
png_file = build_png_filename(file,slicenum,axisnum,output_directory)
print ('*** build_png_filename = ',png_file)

png_file = build_png_filename(file,slicenum,axisnum)
print ('*** build_png_filename = ',png_file)
