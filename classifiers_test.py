...
def KFoldCrossValidation(train_and_test_indexes, X_data_frame, y_data_frame, classifier='knn', k_value=3, kcv_value=10, smote=True, debug=False):
...
def main(argv):
    ...
    print('\n* Results afer {1} runnings:\n{0}'.format(all_acc, __TOTAL_RUNNINGS))
